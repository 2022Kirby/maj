    <footer>
        ...
        <div>
            <p>
                <b><abbr title="Moissac Animation Jeunes"><?= $site->nom() ?></abbr></b>
            </p>
        </div>

        <!-- adhésion -->
        <div>
            <?= $site->adhesion()->kirbytext() ?>

            <p>
                <a $class href="<?= $pages->find('adhesion')->url() ?>">En savoir plus...</a>
            </p>
        </div>

        <!-- adresse / numéro / réseaux sociaux -->
        <div>
        ...
        <div>
            <p>
                <a href="<?= $pages->find('contact')->url() ?>">Nous contacter</a>
            </p>

            <p>
                <a $class href="<?= $pages->find('nous-trouver')->url() ?>">Nous trouver</a>
            </p>

            <p>
                <a href="<?= $pages->find('mentions-legales')->url() ?>">Mentions légales</a>
            </p>
        </div>

        <!-- crédits -->
        <div>
            <p>Site réalisé avec <a href="https://getkirby.com/" target="_blank">Kirby</a></p>

            <p>Design par <a href="https://www.lesyeuxvairons.com//" target="_blank">Les yeux vairons</a></p>
        </div>
    </footer>